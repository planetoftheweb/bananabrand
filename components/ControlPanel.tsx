...
export const ControlPanel: React.FC<ControlPanelProps> = ({
  ...
  const DropdownButton = ({ icon: Icon, label, isActive, onClick, subLabel }: any) => (
    <button
      ...
      className={`h-full px-3 py-2 border rounded-lg flex items-center gap-2 transition-all min-w-[140px] md:min-w-[160px] justify-between group ${
        isActive 
          ? 'bg-gray-100 dark:bg-[#1c2128] border-indigo-500 text-indigo-600 dark:text-indigo-400' 
    ...
    >
      <div className="flex items-center gap-2.5 overflow-hidden text-left">
        <Icon size={16} className={isActive ? "text-indigo-600 dark:text-indigo-400" : "text-slate-500 group-hover:text-slate-700 dark:group-hover:text-slate-400"} />
      ...
      <ChevronDown size={14} className={`transition-transform duration-200 text-slate-500 ${isActive ? 'rotate-180 text-indigo-600 dark:text-indigo-400' : ''}`} />
    </button>
  );
  ...
  const inputClass = "w-full bg-white dark:bg-[#0d1117] border border-gray-200 dark:border-[#30363d] text-slate-900 dark:text-white text-sm rounded-lg p-3 focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 transition-all placeholder-slate-400 dark:placeholder-slate-600";
    ...
    <div className="flex items-center gap-1">
      <div className={`flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity ${isSelected ? 'mr-2' : ''}`}>
        <button 
          ...
          className="p-1.5 hover:bg-gray-100 dark:hover:bg-[#30363d] rounded-md text-slate-500 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors"
          title="Edit"
        >
          <Pencil size={12} />
        </button>
            ...
            <div className="relative">
              ...
              {activeDropdown === 'type' && (
                <div className="absolute top-full left-0 mt-2 w-64 bg-white dark:bg-[#161b22] border border-gray-200 dark:border-[#30363d] rounded-xl shadow-xl z-50 overflow-hidden animate-in fade-in zoom-in-95 duration-150 flex flex-col">
                      ...
                      return (
                        <div key={t.id} className="group flex items-center justify-between p-2 hover:bg-gray-100 dark:hover:bg-[#21262d] rounded-md cursor-pointer" onClick={() => handleChange('graphicTypeId', t.id)}>
                          <div className="flex items-center gap-3">
                            <Icon size={16} className={isSelected ? 'text-indigo-600 dark:text-indigo-400' : 'text-slate-500'} />
                            <span className={`text-xs ${isSelected ? 'text-indigo-600 dark:text-indigo-400 font-bold' : 'text-slate-700 dark:text-slate-300'}`}>{t.name}</span>
                          </div>
                  ...
                  <button onClick={() => openModal('type')} className="w-full text-left p-3 text-xs font-bold text-indigo-600 dark:text-indigo-400 border-t border-gray-200 dark:border-[#30363d] hover:bg-gray-100 dark:hover:bg-[#21262d] flex items-center gap-2 transition-colors">
              ...
              />
               {activeDropdown === 'style' && (
                <div className="absolute top-full left-0 mt-2 w-72 bg-white dark:bg-[#161b22] border border-gray-200 dark:border-[#30363d] rounded-xl shadow-xl z-50 overflow-hidden animate-in fade-in zoom-in-95 duration-150 flex flex-col">
                      ...
                      return (
                        <div key={s.id} className="group relative p-2 hover:bg-gray-100 dark:hover:bg-[#21262d] rounded-md cursor-pointer" onClick={() => handleChange('visualStyleId', s.id)}>
                          <div className="flex justify-between items-start">
                             <div className="flex items-center gap-3">
                                <Icon size={16} className={`mt-0.5 ${isSelected ? 'text-indigo-600 dark:text-indigo-400' : 'text-slate-500'}`} />
                                <span className={`text-xs block ${isSelected ? 'text-indigo-600 dark:text-indigo-400 font-bold' : 'text-slate-700 dark:text-slate-300'}`}>{s.name}</span>
                             </div>
                  ...
                  <button onClick={() => openModal('style')} className="w-full text-left p-3 text-xs font-bold text-indigo-600 dark:text-indigo-400 border-t border-gray-200 dark:border-[#30363d] hover:bg-gray-100 dark:hover:bg-[#21262d] flex items-center gap-2 transition-colors">
            ...
            <div className="relative">
              ...
              {activeDropdown === 'color' && (
                <div className="absolute top-full left-0 mt-2 w-64 bg-white dark:bg-[#161b22] border border-gray-200 dark:border-[#30363d] rounded-xl shadow-xl z-50 overflow-hidden animate-in fade-in zoom-in-95 duration-150 flex flex-col">
                      ...
                      return (
                        <div key={c.id} className="group p-2 hover:bg-gray-100 dark:hover:bg-[#21262d] rounded-md cursor-pointer" onClick={() => handleChange('colorSchemeId', c.id)}>
                          <div className="flex justify-between items-center mb-1.5">
                            <span className={`text-xs ${isSelected ? 'text-indigo-600 dark:text-indigo-400 font-bold' : 'text-slate-700 dark:text-slate-300'}`}>{c.name}</span>
                  ...
                  <button onClick={() => openModal('color')} className="w-full text-left p-3 text-xs font-bold text-indigo-600 dark:text-indigo-400 border-t border-gray-200 dark:border-[#30363d] hover:bg-gray-100 dark:hover:bg-[#21262d] flex items-center gap-2 transition-colors">
            ...
            <div className="relative">
              ...
              {activeDropdown === 'size' && (
                <div className="absolute top-full left-0 mt-2 w-56 bg-white dark:bg-[#161b22] border border-gray-200 dark:border-[#30363d] rounded-xl shadow-xl z-50 overflow-hidden animate-in fade-in zoom-in-95 duration-150 flex flex-col">
                    ...
                    {options.aspectRatios.map(r => {
                      ...
                      return (
                        <div key={r.value} className="group flex items-center justify-between p-2 hover:bg-gray-100 dark:hover:bg-[#21262d] rounded-md cursor-pointer" onClick={() => handleChange('aspectRatio', r.value)}>
                          <div className="flex items-center gap-3">
                             <Icon size={16} className={isSelected ? 'text-indigo-600 dark:text-indigo-400' : 'text-slate-500'} />
                             <span className={`text-xs ${isSelected ? 'text-indigo-600 dark:text-indigo-400 font-bold' : 'text-slate-700 dark:text-slate-300'}`}>{r.label}</span>
                          </div>
                  ...
                  <button onClick={() => openModal('size')} className="w-full text-left p-3 text-xs font-bold text-indigo-600 dark:text-indigo-400 border-t border-gray-200 dark:border-[#30363d] hover:bg-gray-100 dark:hover:bg-[#21262d] flex items-center gap-2 transition-colors">
        ...
        <div className="space-y-4">
          ...
          <div className="pt-4 flex gap-3">
             ...
             <button 
                ...
                className="flex-1 py-2.5 rounded-lg bg-indigo-600 hover:bg-indigo-700 text-white font-medium text-sm shadow-lg shadow-indigo-500/20 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
             >
